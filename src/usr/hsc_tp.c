...
void hsc_tp_init(Program* prog)
{
    ...
    prog->desc =
        ...
        "VGA driver mode. '-i' tests the image draw function. '-m' proced"
        "urally draws the Macbeth chart. '-t' tests string drawing. '-o' "
        "draw the original test image. '-p' tests pane drawing.";
