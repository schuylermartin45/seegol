...
static void __hsc_tp_draw_board(void)
{
    ...
    uint16_t w = gl_lib_getw() / 8;
    uint16_t h = gl_lib_geth() / 8;
    uint16_t color = 0;
    ...
    for (uint8_t row=0; row<8; ++row)
    {
        ...
        {
            gl_lib_draw_rect_wh(w*col, h*row, w, h, color);
            // next color
            color++;
        }
    }
...
{
    // white border
    gl_lib_draw_rect_wh(50, 30, 220, 140, 63);
    // H
    gl_lib_draw_rect_wh( 65, 40, 20, 120, 8);
    gl_lib_draw_rect_wh( 85, 95, 20,  10, 8);
    gl_lib_draw_rect_wh(105, 40, 20, 120, 8);
    // S
    gl_lib_draw_rect_wh(135,  43, 20, 60, 8);
    gl_lib_draw_rect_wh(155,  40, 40, 25, 8);
    gl_lib_draw_rect_wh(155,  90, 20, 20, 8);
    gl_lib_draw_rect_wh(175,  95, 20, 63, 8);
    gl_lib_draw_rect_wh(135, 135, 40, 25, 8);
    // C
    gl_lib_draw_rect_wh(205,  43, 20, 114, 8);
    gl_lib_draw_rect_wh(225,  40, 40,  20, 8);
    gl_lib_draw_rect_wh(225, 140, 40,  20, 8);
    // I'm lazy at this point...screw the z axis.
    // white stripes on the logo
    gl_lib_draw_rect_wh(50, 135, 220, 3, 63);
    gl_lib_draw_rect_wh(50, 143, 220, 3, 63);
    gl_lib_draw_rect_wh(50, 150, 220, 3, 63);
}
